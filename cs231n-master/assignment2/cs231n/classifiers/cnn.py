  ...
  """
    ...
    """
        ...
        self.params['W2'] = weight_scale * np.random.randn(
            (H / 2) * (W / 2) * num_filters, hidden_dim)
    ...
    """
        ...
        scores, cache_forward_3 = affine_forward(affine_relu_2,
                                                 self.params['W3'],
                                                 self.params['b3'])
        #pass
        ############################################################################
        ...
        # Add regularization
        loss += self.reg * 0.5 * (np.sum(self.params['W1']**2) + np.sum(
            self.params['W2']**2) + np.sum(self.params['W3']**2))
        ...
        dX1, grads['W1'], grads['b1'] = conv_relu_pool_backward(
            dX2, cache_forward_1)
